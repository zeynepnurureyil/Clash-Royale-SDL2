...
└── README.md            # Teknik dokümantasyonDerleme Komutu
Oyun motorunun tüm modülleri, matematik kütüphanesi ve SDL2 bağlayıcıları (linkers) dahil edilerek şu şekilde derlenir:gcc main.c graphics.c game.c -o ClashTacticalCore -lSDL2 -lSDL2main -lmProjenin doğru çalışması için önce veri üretici Python scripti tetiklenmeli, ardından derlenen ikili (binary) dosya çalıştırılmalıdır:

Bash
python map_generator.py
./ClashTacticalCore# ⚔️ Clash Royale Tactical Core: Hibrit Mimari ile Gerçek Zamanlı Strateji Oyunu Motoru
